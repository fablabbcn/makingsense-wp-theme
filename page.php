<?php if ($post->ID == 11): ?>
	<?php wp_redirect( esc_url( home_url() ).'/project' , 301 ); exit; ?>	
<?php endif ?>
<?php if ($post->ID == 9): ?>
	<?php wp_redirect( esc_url( home_url() ).'/publication_categories/publications' , 301 ); exit; ?>	
<?php endif ?>
<?php get_header(); ?>
	<?php if (have_posts()) :?>
	<?php while (have_posts()) : the_post() ?>
	<div class="default-page post-area container">
