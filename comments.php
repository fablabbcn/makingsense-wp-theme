	...
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
		<fieldset>
			...
			<?php endif; ?>
				...
				<dd><textarea name="comment" id="comment" class="form-control" cols="50" rows="10"></textarea></dd>
				<dd><input name="submit" type="submit" id="submit" class="btn btn-primary" value="Submit" /></dd>
			</dl>
